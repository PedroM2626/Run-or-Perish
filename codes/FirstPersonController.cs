...
public class FirstPersonController : MonoBehaviour
{
    ...
    private UnityEngine.UI.Image crosshairObject;
    ...
    public UnityEngine.UI.Image sprintBarBG;
    ...
    private void Awake()
    {
        ...
        crosshairObject = GetComponentInChildren<UnityEngine.UI.Image>();
    ...
    private void Update()
    {
        ...
        if(cameraCanMove && PauseResume.GamePaused == false)
        {
...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        if(fpc.useSprintBar)
        {
            ...
            fpc.sprintBarBG = (UnityEngine.UI.Image)EditorGUILayout.ObjectField(fpc.sprintBarBG, typeof(UnityEngine.UI.Image), true);
            EditorGUILayout.EndHorizontal();

            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.PrefixLabel(new GUIContent("Bar", "Object to be used as sprint bar foreground."));
            fpc.sprintBar = (UnityEngine.UI.Image)EditorGUILayout.ObjectField(fpc.sprintBar, typeof(UnityEngine.UI.Image), true);
            EditorGUILayout.EndHorizontal();
